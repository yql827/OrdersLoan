			...
			<div class="tr_rechbox">
				<div class="tr_rechhead">
					...
					<div class="tr_rechheadcion">
						...
						<span>当前余额：<span>1000元</span></span>
					</div>
				</div>
					...
					<ul class="ui-choose am-form-group" id="uc_01">
						<li>
							<label class="am-radio-inline">
									<input type="radio"  value="" name="docVlGender" required data-validation-message="请选择一项充值额度"> 1000￥
								</label>
						</li>
						<li>
							<label class="am-radio-inline">
						...
						<li>
							<label class="am-radio-inline">
									<input type="radio" name="docVlGender" data-validation-message="请选择一项充值额度"> 4000 ￥
								</label>
						</li>
						<li>
							<label class="am-radio-inline">
				...
				<div class="tr_rechoth am-form-group">
					<span>其他金额：</span>
					<input type="number" min="10" max="10000" value="10.00元" class="othbox" data-validation-message="充值金额范围：1000-200000元" />
