		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tbody>
				<tr class="text-c">
					...
					<td class="f-14 td-manage"><a style="text-decoration:none" onClick="user_shenhe(this,'10001')" href="javascript:;" title="审核">审核</a> </a>&nbsp;&nbsp;<a title="删除" href="javascript:;" onclick="member_del(this,'1')" class="ml-5" style="text-decoration:none">删除</a></td>
				</tr>
			</tbody>
		</table>
	</div>
